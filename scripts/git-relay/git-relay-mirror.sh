...
usage:
   git-relay-mirror.sh [OPTIONS]
   git-relay-mirror.sh -h
...
git fetch relay $dest_repo_branch

# Check we can fast-forward destination repo branch
#Rainmaker profile manager has example of this

# Fast-forward destination repo
git push relay $dest_repo_branch
